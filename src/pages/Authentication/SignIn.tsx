...
// import Logo from "./pimax.jpeg";
import "./App.css";
const SignIn = () => {
  return (
    <div className="">
      <div className="h-[100vh] rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center h-full py-5">
          <div className="hidden w-full lg:block lg:w-1/2 h-full">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block navbar-brand " to="/">
                <img
                  // className=" dark:block"
                  src="/images/logo_n.png"
                  alt="Logo"
                  className="w-[150px] h-[150px] object-cover border  border-b-[1px] border-white"
                />
          ...
          <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2 h-full">
